...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .4 #pourcentage in screen width
    vertical_lines = []

    H_NB_LINES = 8
    H_LINES_SPACING = .15 #pourcentage in screen width
    horizontal_lines = []
    ...
    def generate_tiles_coordinate(self):
        last_y = 0
        last_x = 0
        #supprimé les coordonnées sorties de l'écran
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_has_started:
    ...
    def play_voice_game_over(self, dt):
        if self.state_game_over: self.sound_gameover_voice.play()
